...
module.exports = {
    ...
    SESSION: PROCESS.ENV.NAUGHTY_CODE === undefined ? '' : process.env.AMALSER_CODE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+27658052694' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Amalser' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Naughty-girl' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Naughty-girl' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '27658052694@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ NAUGHTY-GIRL ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    BOTCREATOR: "ben-monster",
    MAHN: "27658052694,0",
    SUPPORT: "27658052694-1635775355",
